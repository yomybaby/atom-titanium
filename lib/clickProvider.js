            ...
            callback (){
              _.defer(function () {
                atom.workspace.open(relatedPath,{
                  ...
                  var insertText = atom.config.get('titanium-alloy.styleClassTemplate');
                  insertText = insertText.replace('${text}',text);
            ...
            callback (){
              _.defer(function () {
                atom.workspace.open(relatedPath,{
                  ...
                  var insertText = atom.config.get('titanium-alloy.styleIdTemplate');
                  insertText = insertText.replace('${text}',text);
                  var lastRow = te.getLastBufferRow();
                  var lastPosition = [lastRow,te.lineTextForBufferRow(lastRow).length-1];
                  te.setTextInBufferRange([lastPosition, lastPosition], insertText);
            ...
            callback (){
              _.defer(function () {
                atom.workspace.open(relatedPath,{
                  ...
                  var insertText = atom.config.get('titanium-alloy.functionTemplate');
                  insertText = insertText.replace('${text}',text);
                  var lastRow = te.getLastBufferRow();
                  var lastPosition = [lastRow,te.lineTextForBufferRow(lastRow).length-1];
                  te.setTextInBufferRange([lastPosition, lastPosition], insertText);
