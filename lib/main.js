...
module.exports = Titanium = {
  activate() {
    ...
    return require('atom-package-deps').install('titanium-alloy');
  },
  ...
  config: {
    ...
    alloyAppPath: {
      title: 'Alloy "app" directory name. If you use different directory as a app source, change this setting',
      type: 'string',
      default: 'app'
    }
  }
